...
#define DEBUG(str,...) log::log::get_debug()->out(__FILE__,__LINE__,str,## __VA_ARGS__)
#define INFO(str,...) log::log::get_info()->out(__FILE__,__LINE__,str,## __VA_ARGS__)
#define WARNING(str,...) log::log::get_warning()->out(__FILE__,__LINE__,str,## __VA_ARGS__)
#define ERROR(str,...) log::log::get_error()->out(__FILE__,__LINE__,str,## __VA_ARGS__)
#define FATAL(str,...) log::log::get_fatal()->out(__FILE__,__LINE__,str,## __VA_ARGS__)
}